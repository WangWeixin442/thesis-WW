...
Theorem \ref{thm:MFG-construction} is a generalization of Theorem \ref{thm:MF-construction}, where the correlation between $\SO{3}$ and $\mathbb{R}^n$ is inherited from the correlation between $\mathbb{R}^9$ and $\mathbb{R}^n$ before conditioning.
...
\begin{theorem} \label{thm:MFG-moment}
	...
	\end{align}
	where $\mathrm{E}[\nu_R\nu_R^T]\in\mathbb{R}^{3\times3}$ is a diagonal matrix with the $i$-th diagonal element given by
...
\begin{theorem} \label{thm:MFG-MLE-conditional}
	Let $U,V\in\SO{3}$ and $S\in\mathbb{R}^{3\times 3}$ be the solution of the marginal MLE for $R$.
...
Define a metric $\lambda_{s_i}\in\mathbb{R}$ as
\begin{equation}
