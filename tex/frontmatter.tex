...
%\hidecommitteepage 
\committee{ %
Taeyoung Lee, Professor of Mechanical and Aerospace Engineering,\\ 
...
Peng Wei, Assistant Professor of Mechanical and Aerospace Engineering, \\
Committee Member\\

Chung Hyuk Park, Associate Professor of Biomedical Engineering, \\
Committee Member\\

Uwe Hanebeck, Professor of Computer Science, \\
Karlsruhe Institute of Technology, Committee Member\\

Kyle DeMars, Associate Professor of Aerospace Engineering, \\
...
% Acknowledgments
\acknowledgments{
    Obtaining the PhD degree is one of the most exciting achievements I have made in my life, which is only possible after receiving numerous help and supports from people surrounding me.
    First, I would like to thank my PhD advisor, Prof. Taeyoung Lee, who has led the overall direction, and provided many insights into overcoming obstacles in my research.
    Under his supervision, I was given great freedom to pursue my own ideas, and he offered indispensable advice with his experience to make these immature ideas into successful approaches for the research problems I studied.
    
    I was introduced into inertial navigation research by my undergraduate advisor Prof. Chenglong Fu, and continued in this direction during my master's studies supervised by Prof. Peter Adamczyk.
    Without their initial guidance, I would never have gained so many interests in the research problems I studied, which motivated me to switch my attention from practical problems into the theories behind.
    
    I would also like to thank all the members of the Flight Dynamics and Control lab, Kanishke Gamagedara, Zichao Hou, Tejaswi KC, Beomyeol Yu, and Maneesha Wickramasuriya.
    Working with them made my graduate life enjoyable, and they also offered me invaluable help in some technical problems and in my everyday life.
    In particular, I want to thank Kanishke Gamagedara for conducting an experiment that is used in my dissertation.
    
    Finally, I owe many thanks to my parents, Guozhong Wang and Xiaofeng Liu.
    They gave me unconditional love since the first day I was born, and always make me feel safe to live in the world.
    Without their supports, both mental and financial, I could hardly achieve  anything in my life.
}
